...
public class ExtCountWindFold<V,K,RV> implements FoldFunction<V, Tuple3<K,Tuple4<Double,Double,Long,Long>, RV>>, ResultTypeQueryable<Tuple3<K,Tuple4<Double,Double,Long,Long>, RV>> {
        ...
        public ExtCountWindFold(KeySelector<V, K> key, PayloadFold<V, RV> valueFold, Time window, TypeInformation<Tuple3<K, Tuple4<Double,Double,Long,Long>, RV>> resultType){
            this.plf = valueFold;
            this.kSelect = key;
